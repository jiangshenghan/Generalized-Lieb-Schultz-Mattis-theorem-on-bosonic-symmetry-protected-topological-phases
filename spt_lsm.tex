...
% "anomaly matching", constraint on possible symmetry enriched topological~(SET) phases.
...
\begin{widetext}
  \begin{align}
 %   \begin{matrix}
 %     \vdots& & \vdots\quad\  & & \vdots\quad\ & & \vdots\quad\ & &\notag\\
 %     \uparrow& & \uparrow\quad\  & & \uparrow\quad\ & & \uparrow\quad\ & &\notag\\
 %   0 & \rightarrow & C^{d+1,0} & \xlongrightarrow{\dd_>} & C^{d+1,1} & \xrightarrow{\dd_>} & C^{d+1,2} & \rightarrow & \cdots\notag\\
 %  \uparrow& & \big\uparrow \text{\scriptsize$\dd_\wedge$} & & \big\uparrow \text{\scriptsize$\dd_\wedge$} && \big\uparrow  \text{\scriptsize$\dd_\wedge$} & & \notag\\
 %   0 & \rightarrow & C^{d,0} & \xrightarrow{\dd_>} & C^{d,1} & \xrightarrow{\dd_>} & C^{d,2} & \rightarrow & \cdots\notag\\
 %     \uparrow& & \uparrow\quad\  & & \uparrow\quad\ & & \uparrow\quad\ & &\notag\\
 %     \vdots& & \vdots\quad\  & & \vdots\quad\ & & \vdots\quad\ & &\notag\\
 %     \uparrow& & \uparrow\quad\  & & \uparrow\quad\ & & \uparrow\quad\ & &\notag\\
 %   0 & \rightarrow & C^{0,0} & \xrightarrow{\dd_>} & C^{0,1} & \xrightarrow{\dd_>} & C^{0,2} & \rightarrow & \cdots\notag\\
 %    \uparrow& & \uparrow\quad\  & & \uparrow\quad\ & & \uparrow\quad\ & &\notag\\
 %   0 & \rightarrow & 0 & \longrightarrow & 0 & \longrightarrow & 0 & \longrightarrow & \cdots
 % \end{matrix}
    \begin{matrix}
